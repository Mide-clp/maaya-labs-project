...
def main():
    ...
    cur, engine = establish_connection(host="localhost", port="5432", db="postgres", user="root", password="root")
    ...
    cur, engine = establish_connection(host="localhost", port="5432", db="company_x", user="root", password="root")
